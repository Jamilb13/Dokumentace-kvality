# Utilita pro Tvorbu Dokumentace Kvality (v1.2.0)
...
Aplikace **Utilita pro Tvorbu Dokumentace Kvality** slouží k automatizovanému zpracování, hromadnému přečíslování, razítkování a kompletaci PDF dokumentů kvality (*Quality Documentation*) podle podadresářové struktury.
...
- **Automatické rozpoznání adresářů & Unifikované označení**:
  ...
  - Podpora libovolné hloubky vnoření adresářů (5 i více úrovní) bez duplikování prefixů.
- **Obousměrné živé propojení s MS Excel**:
  - Záložka **Konfigurace**: Kompletní nastavení (Cesty, Otáčení, Zachování struktury, Razítko, Barvy, Fonty).
...
- **Master PDF se Strukturovanými Záložkami**:
  - Sloučení všech zpracovaných PDF do jednoho kompletního dokumentu (`Kompletní_Dokumentace_Kvality.pdf`).
...
| [`excel_manager.py`](file:///c:/Users/behalek/OneDrive%20-%20AUTEL,%20a.s/Antigravity/DK/excel_manager.py) | Správa MS Excelu (`openpyxl` + `win32com.client`), čtení a zápis záložek Konfigurace a Seznam. |
